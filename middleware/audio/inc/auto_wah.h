 ...
 * @param freq_min Minimum frequency in the modulation's sweep range. Range: 100 ~ freq_max Hz. i.e. freq_min should be more than 100 and no more than freq_max.
 * @param freq_max Maximum frequency in the modulation's sweep range. Range: freq_min ~ 5000 Hz. i.e. freq_max should be less than 5000 and no less than freq_min.
